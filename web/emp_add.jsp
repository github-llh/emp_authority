...
<main class="w-50 m-auto">
      <div class="w-75 mb-3">
            <h1 class="h3 fw-normal m-auto">添加页面</h1>
      </div>
      <form class="row g-3">
            <%--文本框 一行二框加验证--%>
            <div class="col-md-3 form-floating">
                  <input type="text" name="ename" class="form-control" id="ename" placeholder="请输入用户名" onblur="checkName()">
            ...
            <%--文本框 一行二框加验证--%>
            <div class="col-md-3 form-floating">
                  <input type="text" name="nickName" class="form-control" id="nickName" placeholder="请输入用户昵称" onblur="checkNickName()">
            ...
            <div class="col-md-3 form-floating">
                  <input type="text" name="tel" class="form-control" id="tel" placeholder="请输入电话" onblur="checkTel()">
            ...
            <%--文本框 一行二框加验证--%>
            <div class="col-md-3 form-floating">
                  <input type="text" name="email" class="form-control" id="email" placeholder="请输入邮箱" onblur="checkEmail()">
            ...
            <div class="col-md-4 form-floating">
                  状态：
                  <input type="radio" name="status" value="0" onclick="checkStatus()">正常
                  <input type="radio" name="status" value="1" onclick="checkStatus()">禁用
            </div>
            ...
            <button class="w-75 btn btn-lg btn-primary" type="button" onclick="addEmp()">提交</button>
      </form>
</main>
